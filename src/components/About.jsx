...
import CV from "../assets/deepanksha_resume.pdf";
      ...
      <section className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            My Name is Deepanksha Pal.I am a hardworking Engineering Graduate,
            Technology Enthusiast, Keen to learn and implement my skills as a
            React Developer.I believe in continous learning and creating
            differnt, scalabe and complex web applications.My strengths are
            hardworking, self-motivated and positive mind set.
          </p>
